...
<body>
    ...
    <body>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" id="inputunit1">
                            <option id="km">Kilometer</option>
                            <option id="ml">Miles</option>
                            <option id="mtr">Meters</option>
                            <option id="cm">Centimeter</option>
                            <option id="mm">Milimeter</option>
                        </select>
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" id="inputunit2">
                            <option id="km1">Kilometer</option>
                            <option id="ml1">Miles</option>
                            <option id="mtr1">Meters</option>
                            <option id="cm1">Centimeter</option>
                            <option id="mm1">Milimeter</option>
                        </select>
                    </div>
                </div>
        ...
        <script>
            $('#inputunit1').on('change', function(e) {
                var optionSelected = $('#inputunit1').find(":selected").text();

                to_selected(optionSelected);

            });
            $('#inputunit2').on('change', function(e) {
                var optionSelected = $('#inputunit2').find(":selected").text();
                from_selected(optionSelected);     

            });

            function to_selected(selected) {
                $.ajax({
                    type: 'POST',
                    url: 'ld.php',
                    data: {
            ...
            function from_selected(selected) {
                $.ajax({
                    type: 'POST',
                    url: 'ld.php',
                    data: {
