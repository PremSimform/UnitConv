                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" id="inputunit1">
                            <option id="kg">Kilogram</option>
                            <option id="gm">Gram</option>
                            <option id="ton">Ton</option>
                        </select>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="input2">Mass/Weight-2</label>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <option id="kg1">Kilogram</option>
                            <option id="gm1">Gram</option>
                            <option id="ton1">Ton</option>
                        </select>
                    </div>
                </div>
