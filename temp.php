        ...
        <div id="form">
            <form style="width: 80%;">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="inputunit1">Temprature</label>
                        <!-- <input type="password" class="form-control" id="inputPassword4" placeholder="Password"> -->
                        <select class="form-control" id="inputunit1">
                            <option id="c">Celcius</option>
                            <option id="fh">Fahrenheit</option>
                        </select>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="input2">Temprature-2</label>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" id="inputunit2">
                            <option id="c1">Celcius</option>
                            <option id="fh1">Fahrenheit</option>
                        </select>
                    </div>
                </div>
